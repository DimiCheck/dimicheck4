...
class Config:
    ...
    DDOS_GUARD_WINDOW_SECONDS: int = int(os.getenv("DDOS_GUARD_WINDOW_SECONDS", "60"))
    DDOS_GUARD_API_VERSION_MAX_REQUESTS: int = int(os.getenv("DDOS_GUARD_API_VERSION_MAX_REQUESTS", "120"))
    DDOS_GUARD_HEALTHZ_MAX_REQUESTS: int = int(os.getenv("DDOS_GUARD_HEALTHZ_MAX_REQUESTS", "60"))
    DDOS_GUARD_METRICS_MAX_REQUESTS: int = int(os.getenv("DDOS_GUARD_METRICS_MAX_REQUESTS", "20"))
    DDOS_GUARD_QRNG_MAX_REQUESTS: int = int(os.getenv("DDOS_GUARD_QRNG_MAX_REQUESTS", "20"))
    DDOS_GUARD_WS_CONNECT_MAX_REQUESTS: int = int(os.getenv("DDOS_GUARD_WS_CONNECT_MAX_REQUESTS", "15"))
