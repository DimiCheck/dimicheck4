...
SHOP_CATALOG: tuple[ShopItem, ...] = (
    ShopItem(
        ...
        slot="move_effect",
        name="기본 반짝임",
        description="이동할 때 작은 빛 조각이 가볍게 흩어집니다.",
        price=0,
        rarity="basic",
        preview="spark",
    ),
    ShopItem(
        ...
        slot="move_effect",
        name="별가루 점프",
        description="자석이 도착하는 순간 별가루가 짧게 퍼집니다.",
        price=300,
        rarity="rare",
        preview="stardust",
    ),
    ShopItem(
        ...
        slot="move_effect",
        name="블루 소용돌이",
        description="이동 위치에 푸른 소용돌이가 한 번 감깁니다.",
        price=1200,
        rarity="epic",
        preview="swirl",
    ),
    ShopItem(
        ...
        slot="drag_effect",
        name="은은한 궤적",
        description="드래그 중 자석 뒤로 부드러운 잔상이 남습니다.",
        price=0,
        rarity="basic",
        preview="trail",
    ),
    ShopItem(
        ...
        slot="drag_effect",
        name="파이어 트레일",
        description="드래그하는 동안 따뜻한 불꽃 궤적이 따라옵니다.",
        price=500,
        rarity="rare",
        preview="fire",
    ),
    ShopItem(
        ...
        slot="drag_effect",
        name="네온 잔상",
        description="빠르게 움직일수록 선명한 네온 잔상이 생깁니다.",
        price=1500,
        rarity="epic",
        preview="neon",
    ),
    ShopItem(
        ...
        slot="aura_effect",
        name="소프트 글로우",
        description="보드에서 내 자석 주변에 은은한 빛을 둘러줍니다.",
        price=800,
        rarity="rare",
        preview="glow",
    ),
